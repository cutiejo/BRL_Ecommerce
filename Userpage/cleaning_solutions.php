...
// Fetch products from the "Cleaning Solutions" category (assuming the category id for "Cleaning Solutions" is 70)
$sql = "SELECT * FROM tbl_product WHERE pcategory = 70";
...
<html>
<head>
  <title>BRL Trading - Cleaning Solutions</title>
  <meta charset="UTF-8">
