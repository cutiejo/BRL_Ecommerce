...
<script>
        ...
        var currentPage = 1;
    var totalPages = 5; // Set the total number of pages accordingly
    ...
    function updatePagination() {
        ...
        // You can add code here to fetch and display the data for the current page
    }

    updatePagination(); // Initialize the pagination on page load
    </script>
<!-- Add Stock Modal -->
