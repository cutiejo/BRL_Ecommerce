...
// Fetch products from the "Cleaning Solutions" category (assuming the category id for "Cleaning Solutions" is 75)
$sql = "SELECT * FROM tbl_product WHERE pcategory = 75";
...
<body>
  <header>
    ...
    <div class="header-right">
      ...
      <div class="icons">
        <div class="icon user">
          <a href="<?= $is_logged_in ? 'user_details.php' : '../LOGIN/login.php' ?>">
            <button type="button"><i class="fas fa-user"></i></button>
          </a>
        </div>
        <div class="icon cart">
          <a href="<?= $is_logged_in ? 'view_cart.php' : '../LOGIN/login.php' ?>">
            <button type="button">
        ...
        <div class="icon wishlist">
          <a href="<?= $is_logged_in ? 'wishlist.php' : '../LOGIN/login.php' ?>">
            <button type="button"><i class="fas fa-heart"></i></button>
          </a>
        </div>
        <div class="icon messages">
          <a href="<?= $is_logged_in ? 'message1.php' : '../LOGIN/login.php' ?>">
  ...
  <div class="our-products-section">
    ...
    <div class="product-grid">
      ...
      <?php else: ?>
        ...
        <div class="product-item" onclick="openModal('<?php echo $product['pid']; ?>')">
  ...
  <script>
    ...
    function addToWishlist(productId) {
      $.post('add_to_wishlist.php', { product_id: productId, user_id: <?php echo $user_id ? $user_id : 'null'; ?> }, function(response) {
        if (response === 'success') {
    ...
    function removeFromWishlist(productId) {
      $.post('remove_from_wishlist.php', { product_id: productId, user_id: <?php echo $user_id ? $user_id : 'null'; ?> }, function(response) {
        if (response === 'success') {
